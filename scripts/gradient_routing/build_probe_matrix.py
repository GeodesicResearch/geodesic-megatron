...
``configs/gradient_routing/stories_probe_matrix.yaml``, is 115). This script expands a
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        required=True,
        help="probe-matrix YAML (e.g. configs/gradient_routing/stories_probe_matrix.yaml)",
    )
