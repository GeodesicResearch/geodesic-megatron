#!/bin/bash
# =============================================================================
# MQV2 sem_proc_nomask chain — sbatch dependency-chain driver.
#
# CONTROL ARM (loss masking disabled): nomask twin of sem_proc.
# Trains the same MT → SFT → 5×EM cascade as the masked sem_proc arm,
