...
VENV_DIR="/projects/a5k/public/kyle/uv_envs/geodesic-megatron-vllm-setup"
VENV_SITE_PACKAGES="/projects/a5k/public/kyle/uv_envs/geodesic-megatron-vllm-setup/lib/python3.12/site-packages"
